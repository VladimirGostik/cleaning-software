...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement(
            'CREATE UNIQUE INDEX cleaning_jobs_recurrence_unique ON cleaning_jobs (cleaning_object_id, work_breakdown_task_id, scheduled_date) WHERE deleted_at IS NULL AND work_breakdown_task_id IS NOT NULL',
        );
    }
