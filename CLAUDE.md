...
- Domain modules: Schedule, Employee, Notification, etc.
...
- Contract expiry email notifications (app:check-contract-expiry cron runs, logs to structured log only — email dispatch TBD via Notification module).
- Quote email dispatch + expiry notifications (app:expire-quotes cron runs; email dispatch TBD via Notification module).
