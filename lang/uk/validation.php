...
return [
    ...
    */
    ...
    'accepted_if' => 'Поле :attribute повинно бути прийнятим, коли :other є :value.',
    ...
    'declined_if' => 'Поле :attribute повинно бути відхиленим, коли :other є :value.',
    ...
    'gte' => [
        'array' => 'Поле :attribute повинно мати :value або більше елементів.',
        ...
        'string' => 'Поле :attribute повинно мати :value або більше символів.',
    ],
    ...
    'lte' => [
        ...
        'string' => 'Поле :attribute не повинно мати більше ніж :value символів.',
    ],
    ...
    'min' => [
        ...
        'file' => 'Поле :attribute повинно мати принаймні :min кілобайт.',
        'numeric' => 'Поле :attribute повинно бути принаймні :min.',
        'string' => 'Поле :attribute повинно мати принаймні :min символів.',
    ],
    ...
    'password' => [
        ...
        'uncompromised' => 'Введений :attribute з\'явився у витоку даних. Будь ласка, оберіть інший :attribute.',
    ],
    ...
    'prohibited_if_declined' => 'Поле :attribute заборонено, коли :other відхилений.',
    ...
    'required_if_declined' => 'Поле :attribute є обов\'язковим, коли :other відхилений.',
    ...
    'size' => [
        ...
        'file' => 'Поле :attribute повинно мати :size кілобайт.',
        'numeric' => 'Поле :attribute повинно бути :size.',
        'string' => 'Поле :attribute повинно мати :size символів.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'address_line' => 'Адреса',
        'area_sqm' => 'Площа (м²)',
        'key_count' => 'Кількість ключів',
        'key_box_code' => 'Код ключниці',
        'floor' => 'Поверх',
        ...
        'color' => 'Колір',
        'role_name' => 'Роль',
        'leader_email' => 'Електронна пошта керівника',
        'terms_accepted' => 'Умови використання',
        'position' => 'Посада',
        'is_primary' => 'Основний контакт',
        'is_active' => 'Активний',
        'search' => 'Пошук',
        'sort' => 'Сортування',
        'per_page' => 'Кількість на сторінку',
        'copy_settings' => 'Копіювати налаштування',
